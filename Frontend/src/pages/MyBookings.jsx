...
const MyBookings = () => {
    ...
    return !isLoading ? (
        <div className="relative px-6 md:px-16 lg:px-40 md:pt-32 lg:pt-52 min-h-[80vh]">
            <BlurCircle top="100px" />
            <div>
                <BlurCircle bottom="0px" left="600px" />
            </div>
            <h1 className="text-lg font-medium text-white">My Bookings</h1>
            {bookings.map((item, index) => (
                <div key={index} className="flex flex-col md:flex-row justify-between bg-primary/8
                    ...
                    <div className="flex flex-col md:flex-row">
                        <img src={item.show.movie.poster_path} alt="" className="md:max-w-44 aspect-video
